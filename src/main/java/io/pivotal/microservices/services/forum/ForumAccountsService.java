 ...
 */
@Service
public class ForumAccountsService {
    ...
    protected Logger logger = Logger.getLogger(ForumAccountsService.class.getName());

    public ForumAccountsService(String serviceUrl) {
